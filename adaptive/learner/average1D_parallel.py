...
class AverageLearner1D_parallel(Learner1D):
    ...
    def __init__(self, function, bounds, loss_per_interval = None, delta = 0.2, alfa = 0.005,
        ...
        self._error_in_mean = error_in_mean_initializer() # This SortedDict contains the error in the estimate of the
                                                          # mean at each point x in the form {x0: error(x0), ...}
        self._distances = error_in_mean_initializer() # Distance between two neighboring points in the
